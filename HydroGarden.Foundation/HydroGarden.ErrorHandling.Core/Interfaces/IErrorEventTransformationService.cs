...
namespace HydroGarden.Foundation.ErrorHandling.Core.Interfaces
{
    /// <summary>
    ...
    public interface IErrorEventTransformationService
    {
        ...
        ErrorEvent TransformErrorToEvent(IApplicationError error);
        ...
        IEvent TransformToPublishableEvent(ErrorEvent errorEvent);
        ...
        /// <returns>The event that can be published.</returns>
        IEvent TransformToPublishableEvent(RecoveryEvent recoveryEvent);
        ...
        ErrorEvent ExtractErrorEvent(IEvent @event);
        ...
        RecoveryEvent ExtractRecoveryEvent(IEvent @event);
