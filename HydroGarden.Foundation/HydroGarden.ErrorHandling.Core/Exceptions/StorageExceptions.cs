...
namespace HydroGarden.Foundation.ErrorHandling.Exceptions
{
    ...
    /// </summary>
    public class StorageReadException : ApplicationException
    {
        /// <summary>
    ...
    /// </summary>
    public class StorageWriteException : ApplicationException
    {
        /// <summary>
    ...
    public class StorageTransactionException : ApplicationException
    {
        ...
        /// <param name="innerException">The inner exception.</param>
        public StorageTransactionException(
            string message,
            string storageName,
    ...
    /// </summary>
    public class DataCorruptionException : ApplicationException
    {
        /// <summary>
